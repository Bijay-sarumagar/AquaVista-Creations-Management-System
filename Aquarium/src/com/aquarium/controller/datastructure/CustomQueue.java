package com.aquarium.controller.datastructure;
...
public class CustomQueue {
    ...
    private LinkedList<AquariumModel> vivaList; // Internal storage for the queue.
     ...
     *
     * @return the first AquariumModel in the queue, or null if the queue is
 empty.
     * @throws IllegalStateException if the queue is empty.
     */
    public AquariumModel deQueue() {
        try {
     ...
     *
     * @param studentModel the AquariumModel to be added to the queue.
     * @return the current size of the queue after the operation , or -1 if the
     * queue is full.
     */
    public int enQueue(AquariumModel studentModel) {
        if (isFull()) {
